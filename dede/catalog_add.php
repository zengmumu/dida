...
else if($dopost=='save')
{
    ...
    $in_query = "INSERT INTO `#@__arctype`(reid,topid,sortrank,typename,typedir,typeimg,isdefault,defaultname,issend,channeltype,
    ...
    VALUES('$reid','$topid','$sortrank','$typename','$typedir','$typeimg','$isdefault','$defaultname','$issend','$channeltype',
