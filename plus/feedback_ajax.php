...
<div class="decmt-box2">
  <ul class="am-comments-list am-comments-list-flip">
    <li class="am-g am-comment"> 
        <a href='<?php echo $spaceurl; ?>' class='plpic am-u-sm-2'>
            <img src='<?php echo $mface;?>'  height='40' width='40' class="am-comment-avatar"/>
        </a> 
        <div class="am-u-sm-10">
        
        <div>
            <span class="title am-fl"><a href="<?php echo $spaceurl; ?>"><?php echo $username; ?></a></span>
            <div class="comment_act am-fl"><span class="fl"><?php echo GetDateMk($dtime); ?></span></div>
        </div>
          
          <div style="clear:both"><?php echo ubb($msg); ?></div>
          <div class="newcomment_act"><span class="fr"><span id='goodfb<?php echo $id; ?>'> <a href='#goodfb<?php echo $id; ?>' onclick="postBadGood('goodfb',<?php echo $id; ?>);"><i class="am-icon-thumbs-up"></i> <span class="am-hide">支持</span></a><?php echo $good; ?> </span> <span id='badfb<?php echo $id; ?>'> <a href='#badfb<?php echo $id; ?>' onclick="postBadGood('badfb',<?php echo $id; ?>);"><i class="am-icon-thumbs-down"></i><span class="am-hide">反对</span></a><?php echo $bad; ?> </span> <span class='quote'>
            <!--<a href='/plus/feedback.php?aid=<?php echo $id; ?>&fid=<?php echo $id; ?>&action=quote'>[引用]</a>-->
            <a href='javascript:ajaxFeedback(<?php echo $id; ?>,<?php echo $id; ?>,"quote");'><i class="am-icon-reply"></i><span class="am-hide">引用</span></a> </span></span></div>
        </div>
    </li>
